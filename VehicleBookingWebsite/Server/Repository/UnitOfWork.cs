...
namespace VehicleBookingWebsite.Server.Repository
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        public IGenericRepository<OrderVehicle> OrderVehicles
        ...
        public IGenericRepository<OrderVehicle> OrderVehicle => throw new NotImplementedException();

        public IGenericRepository<VehicleType> VehicleType => throw new NotImplementedException();
